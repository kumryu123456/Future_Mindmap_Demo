...
import type { SessionItem, ExportFormat, ImportOptions } from '../../../types/components/sessionManager';
...
export const AdvancedExample: React.FC = () => {
  const [projectData, setProjectData] = useState<ProjectData>({
    ...
    description: 'Comprehensive project management with SessionManager integration',
    type: 'project',
    phases: [
      {
        id: 'phase1',
  ...
  }, [currentSessionId, projectData.settings.autoSave, setupAutoSave, clearAutoSave, projectData]);
  ...
  return (
    <div className="advanced-example">
      <div className="example-header">
        ...
        <p>
          This example demonstrates advanced features including export/import, validation, 
          local storage management, and integration with complex project data.
        </p>
      </div>
      ...
      <div className="example-content">
        ...
        <div className="project-dashboard">
          <div className="dashboard-header">
            ...
            <div className="project-stats">
              ...
              <div className="stat">
                ...
                <span className="stat-value">{projectData.collaborators.length}</span>
              </div>
              <div className="stat">
          ...
          <div className="task-management">
            <div className="section-header">
              <h4>Tasks</h4>
              <button onClick={handleAddTask} className="btn btn--primary btn--small">
                Add Task
              </button>
            </div>
        ...
        <div className="advanced-features">
          ...
          <div className="feature-section">
            ...
            <button onClick={handleValidateSession} className="btn btn--secondary">
          ...
          {storageStats && (
            <div className="feature-section">
              ...
              <div className="storage-stats">
                ...
                <div>Storage Used: {(storageStats.totalSize / 1024 / 1024).toFixed(2)} MB</div>
                ...
                <details>
                  ...
                  <div className="sessions-breakdown">
                    {storageStats.sessionsBreakdown.slice(0, 5).map((session: any) => (
          ...
          <SessionManager
            ...
            onValidate={(sessionData) => {
              ...
              if (projectData.tasks && projectData.tasks.length > 50) {
                warnings.push({
                  code: 'MANY_TASKS',
                  message: 'This project has many tasks, consider organizing into phases',
                  recommendation: 'Break down into smaller phases for better management'
                });
              }
              ...
              return {
                ...
                errors,
                warnings,
                integrityScore: Math.max(0, 100 - (errors.length * 15) - (warnings.length * 5))
              };
            }}
          />
        </div>
      ...
      <div className="example-footer">
        ...
        <ul>
          ...
          <li>✅ Export to multiple formats (JSON, CSV, XML, HTML, Markdown)</li>
